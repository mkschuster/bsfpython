...
class Analysis(object):
    ...
    def get_html_header(
        ...
        str_list.append('<meta name="DC.Creator" content="' + cgi.escape(s=creator, quote=True) + '" />\n')
        str_list.append('<meta name="DC.Date" content="' + datetime.datetime.now().isoformat() + '" />\n')
        str_list.append('<meta name="DC.Source" content="' + cgi.escape(s=source, quote=True) + '" />\n')
        str_list.append('<meta name="DC.Title" content="' + cgi.escape(s=title, quote=True) + '" />\n')
        str_list.append('<title>' + cgi.escape(s=title, quote=True) + '</title>\n')
        str_list.append('</head>\n')
        str_list.append('\n')
    ...
    def get_html_footer(
        ...
        if institution:
            str_list.append('This report was generated by ' + cgi.escape(s=institution, quote=True) + '\n')
        ...
        if contact:
            ...
            str_list.append('Contact: <a href="mailto:' + urllib.quote(s=contact) +
                            '?subject=' + urllib.quote(s=title) + '">')
            str_list.append(cgi.escape(s=contact, quote=True))
            str_list.append('</a>')
        str_list.append('</p>\n')
        str_list.append('</body>\n')
