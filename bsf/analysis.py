...
class Stage(object):
    ...
    :type is_script: bool
    :ivar template_script: Template script for submission.
    :type template_script: str | None
...
class Analysis(object):
    ...
    def ucsc_track_url(
        ...
        :type browser_dict: dict[str, str] | None
