"""bsf.runnables.rnaseq_cuffdiff

A package of classes and methods to run Cuffdiff of the Cufflinks package.
"""
...
def run_cuffdiff(runnable):
    """Run the I{Cuffdiff} step.
    ...
    runnable.run_executable(name='cuffdiff')
...
def run(runnable):
    ...
    run_cuffdiff(runnable=runnable)
