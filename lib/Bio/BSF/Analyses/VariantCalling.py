...
from Bio.BSF.Data import PairedReads
...
class VariantCallingGATK(Analysis):
    ...
    def _read_comparisons(self, comparison_path):
        ...
        sas = SampleAnnotationSheet.read_from_file(file_path=comparison_path)
    ...
    def run(self):
        ...
        for sample in self.samples:
            ...
            replicate_dict = sample.get_all_PairedReads(replicate_grouping=self.replicate_grouping)
            ...
            for replicate_key in replicate_keys:
                ...
                runnable_process_lane = Runnable(
                    name=prefix_lane,
                    code_module='Bio.BSF.Runnables.variant_calling_process_lane',
                ...
                if not self.skip_mark_duplicates:
                    ...
                    sub_command.add_OptionPair(key='INPUT', value=file_path_dict_lane['aligned_bam'])
                    sub_command.add_OptionPair(key='OUTPUT', value=file_path_dict_lane['duplicates_marked_bam'])
                    sub_command.add_OptionPair(key='METRICS_FILE', value=file_path_dict_lane['duplicate_metrics'])
                    ...
                    sub_command.add_OptionPair(key='TMP_DIR', value=file_path_dict_lane['temporary_directory'])
                ...
                sub_command.add_OptionLong(key='reference_sequence', value=self.bwa_genome_db)
                if self.downsample_to_fraction:
                    sub_command.add_OptionLong(key='downsample_to_fraction', value=self.downsample_to_fraction)
                ...
                if self.skip_mark_duplicates:
                    sub_command.add_OptionLong(key='input_file', value=file_path_dict_lane['aligned_bam'])
                else:
                    sub_command.add_OptionLong(key='input_file', value=file_path_dict_lane['duplicates_marked_bam'])
                sub_command.add_OptionLong(key='out', value=file_path_dict_lane['realigner_targets'])
                ...
                if self.skip_mark_duplicates:
                    ...
                    sub_command.add_OptionLong(key='input_file', value=file_path_dict_lane['duplicates_marked_bam'])
                sub_command.add_OptionLong(key='targetIntervals', value=file_path_dict_lane['realigner_targets'])
                sub_command.add_OptionLong(key='out', value=file_path_dict_lane['realigned_bam'])
                ...
                sub_command.add_OptionLong(key='input_file', value=file_path_dict_lane['realigned_bam'])
                sub_command.add_OptionLong(key='out', value=file_path_dict_lane['recalibration_table_pre'])
                ...
                for file_path in self.known_sites_recalibration:
                    sub_command.add_OptionLong(key='knownSites', value=file_path)
                sub_command.add_OptionLong(key='BQSR', value=file_path_dict_lane['recalibration_table_pre'])
                sub_command.add_OptionLong(key='input_file', value=file_path_dict_lane['realigned_bam'])
                sub_command.add_OptionLong(key='out', value=file_path_dict_lane['recalibration_table_post'])
                ...
                for interval in self.include_intervals_list:
                    sub_command.add_OptionLong(key='intervals', value=interval)
                sub_command.add_OptionLong(key='afterReportFile', value=file_path_dict_lane['recalibration_table_post'])
                sub_command.add_OptionLong(key='beforeReportFile', value=file_path_dict_lane['recalibration_table_pre'])
                sub_command.add_OptionLong(key='plotsReportFile', value=file_path_dict_lane['recalibration_plot'])
                ...
                sub_command.add_OptionLong(key='input_file', value=file_path_dict_lane['realigned_bam'])
                sub_command.add_OptionLong(key='BQSR', value=file_path_dict_lane['recalibration_table_pre'])
                sub_command.add_OptionLong(key='out', value=file_path_dict_lane['recalibrated_bam'])
                ...
                sub_command = java_process.sub_command
                sub_command.add_OptionPair(key='INPUT', value=file_path_dict_lane['recalibrated_bam'])
                sub_command.add_OptionPair(key='OUTPUT', value=file_path_dict_lane['alignment_summary_metrics'])
                sub_command.add_OptionPair(key='METRIC_ACCUMULATION_LEVEL', value='ALL_READS')
                sub_command.add_OptionPair(key='REFERENCE_SEQUENCE', value=self.bwa_genome_db)
                sub_command.add_OptionPair(key='TMP_DIR', value=file_path_dict_lane['temporary_directory'])
                sub_command.add_OptionPair(key='VERBOSITY', value='WARNING')
                sub_command.add_OptionPair(key='QUIET', value='false')
                sub_command.add_OptionPair(key='VALIDATION_STRINGENCY', value='STRICT')
            ...
            runnable_process_sample = Runnable(
                name=prefix_sample,
                code_module='Bio.BSF.Runnables.variant_calling_process_sample',
                working_directory=self.genome_directory,
            ...
            sub_command.add_OptionPair(key='OUTPUT', value=file_path_dict_sample['merged_bam'])
            ...
            sub_command.add_OptionPair(key='TMP_DIR', value=file_path_dict_sample['temporary_directory'])
            sub_command.add_OptionPair(key='VERBOSITY', value='WARNING')
            sub_command.add_OptionPair(key='QUIET', value='false')
            sub_command.add_OptionPair(key='VALIDATION_STRINGENCY', value='STRICT')
            sub_command.add_OptionPair(key='COMPRESSION_LEVEL', value='5')
            ...
            if not self.skip_mark_duplicates:
                ...
                sub_command = java_process.sub_command
                sub_command.add_OptionPair(key='INPUT', value=file_path_dict_sample['merged_bam'])
                sub_command.add_OptionPair(key='OUTPUT', value=file_path_dict_sample['duplicates_marked_bam'])
                sub_command.add_OptionPair(key='METRICS_FILE', value=file_path_dict_sample['duplicate_metrics'])
                # Since read names typically contain a dash and an underscore, the READ_NAME_REGEX needs adjusting,
            ...
            for file_path in self.known_sites_realignment:
                sub_command.add_OptionLong(key='known', value=file_path)
            if self.skip_mark_duplicates:
                sub_command.add_OptionLong(key='input_file', value=file_path_dict_sample['merged_bam'])
            else:
                sub_command.add_OptionLong(key='input_file', value=file_path_dict_sample['duplicates_marked_bam'])
            sub_command.add_OptionLong(key='out', value=file_path_dict_sample['realigner_targets'])
            ...
            if self.skip_mark_duplicates:
                ...
                sub_command.add_OptionLong(key='input_file', value=file_path_dict_sample['duplicates_marked_bam'])
            sub_command.add_OptionLong(key='targetIntervals', value=file_path_dict_sample['realigner_targets'])
            sub_command.add_OptionLong(key='out', value=file_path_dict_sample['realigned_bam'])
            # For debugging only.
            # sub_command.add_OptionLong(key='logging_level', value='DEBUG')
            ...
            sub_command = java_process.sub_command
            sub_command.add_OptionPair(key='INPUT', value=file_path_dict_sample['realigned_bam'])
            sub_command.add_OptionPair(key='OUTPUT', value=file_path_dict_sample['alignment_summary_metrics'])
            sub_command.add_OptionPair(key='METRIC_ACCUMULATION_LEVEL', value='ALL_READS')
            sub_command.add_OptionPair(key='REFERENCE_SEQUENCE', value=self.bwa_genome_db)
            sub_command.add_OptionPair(key='TMP_DIR', value=file_path_dict_sample['temporary_directory'])
            sub_command.add_OptionPair(key='VERBOSITY', value='WARNING')
            ...
            if self.known_sites_discovery:
                sub_command.add_OptionLong(key='dbsnp', value=self.known_sites_discovery)
            sub_command.add_OptionLong(key='input_file', value=file_path_dict_sample['realigned_bam'])
            sub_command.add_OptionLong(key='out', value=file_path_dict_sample['raw_variants_gvcf_vcf'])
        ...
        runnable_process_cohort = Runnable(
            name=prefix_cohort,
            code_module='Bio.BSF.Runnables.variant_calling_process_cohort',
            working_directory=self.genome_directory,
        ...
        sub_command.add_OptionLong(key='out', value=file_path_dict_cohort['combined_gvcf_vcf'])
        ...
        if len(self.accessory_cohort_gvcfs):
            ...
            for file_path in self.accessory_cohort_gvcfs:
                sub_command.add_OptionLong(key='variant', value=file_path)
            sub_command.add_OptionLong(key='variant', value=file_path_dict_cohort['combined_gvcf_vcf'])
            sub_command.add_OptionLong(key='out', value=file_path_dict_cohort['temporary_gvcf_vcf'])
        ...
        if self.known_sites_discovery:
            sub_command.add_OptionLong(key='dbsnp', value=self.known_sites_discovery)
        if len(self.accessory_cohort_gvcfs):
            sub_command.add_OptionLong(key='variant', value=file_path_dict_cohort['temporary_gvcf_vcf'])
        else:
            sub_command.add_OptionLong(key='variant', value=file_path_dict_cohort['combined_gvcf_vcf'])
        sub_command.add_OptionLong(key='out', value=file_path_dict_cohort['genotyped_raw_vcf'])
        ...
        sub_command.add_OptionLong(key='input', value=file_path_dict_cohort['genotyped_raw_vcf'])
        sub_command.add_OptionLong(key='recal_file', value=file_path_dict_cohort['recalibration_snp'])
        sub_command.add_OptionLong(key='tranches_file', value=file_path_dict_cohort['tranches_snp'])
        sub_command.add_OptionLong(key='rscript_file', value=file_path_dict_cohort['plots_snp'])
        ...
        sub_command.add_OptionLong(key='input', value=file_path_dict_cohort['genotyped_raw_vcf'])
        sub_command.add_OptionLong(key='recal_file', value=file_path_dict_cohort['recalibration_indel'])
        sub_command.add_OptionLong(key='tranches_file', value=file_path_dict_cohort['tranches_indel'])
        sub_command.add_OptionLong(key='rscript_file', value=file_path_dict_cohort['plots_indel'])
        ...
        sub_command.add_OptionLong(key='recal_file', value=file_path_dict_cohort['recalibration_snp'])
        sub_command.add_OptionLong(key='tranches_file', value=file_path_dict_cohort['tranches_snp'])
        sub_command.add_OptionLong(key='out', value=file_path_dict_cohort['recalibrated_snp_raw_indel_vcf'])
        # The lodCutoff (VQSLOD score) filter is not applied for the moment.
        if self.truth_sensitivity_filter_level_snp:
            sub_command.add_OptionLong(key='ts_filter_level', value=self.truth_sensitivity_filter_level_snp)
        ...
        for interval in self.include_intervals_list:
            sub_command.add_OptionLong(key='intervals', value=interval)
        sub_command.add_OptionLong(key='mode', value='INDEL')
        sub_command.add_OptionLong(key='input', value=file_path_dict_cohort['recalibrated_snp_raw_indel_vcf'])
        sub_command.add_OptionLong(key='recal_file', value=file_path_dict_cohort['recalibration_indel'])
        sub_command.add_OptionLong(key='tranches_file', value=file_path_dict_cohort['tranches_indel'])
        sub_command.add_OptionLong(key='out', value=file_path_dict_cohort['recalibrated_snp_recalibrated_indel_vcf'])
        # The lodCutoff (VQSLOD score) filter is not applied for the moment.
        if self.truth_sensitivity_filter_level_indel:
            sub_command.add_OptionLong(key='ts_filter_level', value=self.truth_sensitivity_filter_level_indel)
        ...
        if len(self.accessory_cohort_gvcfs):
            ...
            sub_command.add_OptionLong(key='out', value=file_path_dict_cohort['multi_sample_vcf'])
            for sample in self.samples:
        ...
        sub_command.add_OptionShort(key='stats', value=file_path_dict_cohort['snpeff_stats'])
        sub_command.add_OptionShort(key='config', value=os.path.join(self.classpath_snpeff, 'snpEff.config'))
        ...
        sub_command.add_OptionLong(key='snpEffFile', value=file_path_dict_cohort['snpeff_vcf'])
        sub_command.add_OptionLong(key='out', value=file_path_dict_cohort['annotated_vcf'])
        ...
        for sample in self.samples:
            ...
            sub_command.add_OptionLong(key='variant', value=file_path_dict_cohort['annotated_vcf'])
            sub_command.add_OptionLong(key='out', value=file_path_dict_cohort['sample_vcf_' + sample.name])
            sub_command.add_OptionLong(key='sample_name', value=sample.name)
            sub_command.add_SwitchLong(key='excludeNonVariants')
            ...
            sub_command.add_OptionLong(key='variant', value=file_path_dict_cohort['sample_vcf_' + sample.name])
            sub_command.add_OptionLong(key='out', value=file_path_dict_cohort['sample_csv_' + sample.name])
