    ...
    def report(self):
        ...
        if os.path.exists(os.path.join(
            ...
            report_list += '<img ' \
                           ...
                           'src="' + file_path_summary.alignment_percentage_sample_png + '" ' \
                           'height="100" ' \
                           'width="100" />'
            report_list += '</a>'
            report_list += '</td>\n'
            ...
            report_list += '<img ' \
                           ...
                           'src="' + file_path_summary.alignment_percentage_read_group_png + '" ' \
                           'height="100" ' \
                           'width="100" />'
            report_list += '</a>'
            report_list += '</td>\n'
        ...
        if os.path.exists(os.path.join(
            ...
            report_list += '<img ' \
                           ...
                           'src="' + file_path_summary.alignment_absolute_sample_png + '" ' \
                           'height="100" ' \
                           'width="100" />'
            report_list += '</a>'
            report_list += '</td>\n'
            ...
            report_list += '<img ' \
                           ...
                           'src="' + file_path_summary.alignment_absolute_read_group_png + '" ' \
                           'height="100" ' \
                           'width="100" />'
            report_list += '</a>'
            report_list += '</td>\n'
        ...
        if os.path.exists(
            ...
            report_list += '<img ' \
                           ...
                           'src="' + file_path_summary.duplication_percentage_sample_png + '" ' \
                           'height="100" ' \
                           'width="100" />'
            report_list += '</a>'
            report_list += '</td>\n'
        ...
        if os.path.exists(
            ...
            report_list += '<img ' \
                           ...
                           'src="' + file_path_summary.duplication_levels_sample_png + '" ' \
                           'height="100" ' \
                           'width="100" />'
            report_list += '</a>'
            report_list += '</td>\n'
        ...
        if os.path.exists(
            ...
            report_list += '<img ' \
                           ...
                           'src="' + file_path_summary.hybrid_coverage_levels_sample_png + '" ' \
                           'height="100" ' \
                           'width="100" />'
            report_list += '</a>'
            report_list += '</td>\n'
            ...
            report_list += '<a href="' + file_path_summary.hybrid_coverage_levels_read_group_pdf + '">' \
                           ...
                           'src="' + file_path_summary.hybrid_coverage_levels_read_group_png + '" ' \
                           'height="100" ' \
                           'width="100" />'
            report_list += '</a>'
            report_list += '</td>\n'
        ...
        if os.path.exists(os.path.join(
            ...
            report_list += '<img ' \
                           ...
                           'src="' + file_path_summary.hybrid_coverage_sample_png + '" ' \
                           'height="100" ' \
                           'width="100" />'
            report_list += '</a>'
            report_list += '</td>\n'
            ...
            report_list += '<a href="' + file_path_summary.hybrid_coverage_read_group_pdf + '">' \
                           ...
                           'src="' + file_path_summary.hybrid_coverage_read_group_png + '" ' \
                           'height="100" ' \
                           'width="100" />'
            report_list += '</a>'
            report_list += '</td>\n'
        ...
        if os.path.exists(os.path.join(
            ...
            report_list += '<img ' \
                           ...
                           'src="' + file_path_summary.hybrid_excluded_bases_sample_png + '" ' \
                           'height="100" ' \
                           'width="100" />'
            report_list += '</a>'
            report_list += '</td>\n'
            ...
            report_list += '<img ' \
                           ...
                           'src="' + file_path_summary.hybrid_excluded_bases_read_group_png + '" ' \
                           'height="100" ' \
                           'width="100" />'
            report_list += '</a>'
            report_list += '</td>\n'
        ...
        if os.path.exists(os.path.join(
            ...
            report_list += '<img ' \
                           ...
                           'src="' + file_path_summary.hybrid_unique_percentage_sample_png + '" ' \
                           'height="100" ' \
                           'width="100" />'
            report_list += '</a>'
            report_list += '</td>\n'
            ...
            report_list += '<img ' \
                           ...
                           'src="' + file_path_summary.hybrid_unique_percentage_read_group_png + '" ' \
                           'height="100" ' \
                           'width="100" />'
            report_list += '</a>'
            report_list += '</td>\n'
        ...
        if os.path.exists(os.path.join(
            ...
            report_list += '<img ' \
                           ...
                           'src="' + file_path_summary.non_callable_percentage_sample_png + '" ' \
                           'height="100" ' \
                           'width="100" />'
            report_list += '</a>'
            report_list += '</td>\n'
        ...
        if os.path.exists(os.path.join(
            ...
            report_list += '<img ' \
                           ...
                           'src="' + file_path_summary.non_callable_absolute_sample_png + '" ' \
                           'height="100" ' \
                           'width="100" />'
            report_list += '</a>'
            report_list += '</td>\n'
