"""bsf.runnables.rnaseq_cuffnorm

A package of classes and methods to run Cuffnorm of the Cufflinks package.
"""
...
def run_cuffnorm(runnable):
    """Run the I{Cuffnorm} step.
    ...
    runnable.run_executable(name='cuffnorm')
...
def run(runnable):
    ...
    run_cuffnorm(runnable=runnable)
