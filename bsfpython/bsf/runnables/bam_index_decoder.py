...
A package of classes and methods to run C{BamIndexDecoder} C{Analysis} processes.
"""
...
def run_bam_index_decoder(runnable):
    """Run the I{bam_index_decoder} C{Executable} defined in the C{Runnable}.
...
def run_picard_collect_alignment_summary_metrics(runnable):
    """Run the I{picard_collect_alignment_summary_metrics} C{Executable} defined in the C{Runnable}.
