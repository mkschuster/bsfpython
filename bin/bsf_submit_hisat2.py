...
# -*- coding: utf-8 -*-
#
# BSF Python script to drive the HISAT2 Aligner analysis.
#
#
...
argument_parser = argparse.ArgumentParser(
    description=bsf.analyses.hisat.Hisat2.name + ' driver script.')
...
# Create a Hisat2 Analysis and run it.

analysis = bsf.analyses.hisat.Hisat2.from_config_file_path(config_path=name_space.configuration)
