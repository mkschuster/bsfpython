...
#
"""The :py:mod:`bin.bsf_submit_hisat2` module is a script to drive the
:py:class:`bsf.analyses.hisat.Hisat2` analysis.
"""
...
argument_parser = ArgumentParser(
    description=Hisat2.name + ' driver script.')
...
analysis = Hisat2.from_config_file_path(config_path=name_space.configuration)
