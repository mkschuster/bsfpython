...
#
"""The :py:mod:`bin.bsf_submit_rnaseq_tuxedo` module is a script to drive the
:py:class:`bsf.analyses.rnaseq.Tuxedo` analysis.
"""

import logging
from argparse import ArgumentParser

from bsf.analyses.rnaseq import Tuxedo

argument_parser = ArgumentParser(
    description=Tuxedo.name + ' driver script.')
