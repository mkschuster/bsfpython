...
#
"""The :py:mod:`bin.bsf_submit_tophat2` module is a script to drive the
:py:class:`bsf.analyses.tophat.Tophat2` analysis.
"""

import logging
from argparse import ArgumentParser

from bsf.analyses.tophat import Tophat2

argument_parser = ArgumentParser(
    description=Tophat2.name + ' driver script.')
...
analysis = Tophat2.from_config_file_path(config_path=name_space.configuration)
