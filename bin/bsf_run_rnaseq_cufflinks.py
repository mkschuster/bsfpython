#! /usr/bin/env python
#
# BSF Python script to run Cufflinks.
#
#
...
parser = argparse.ArgumentParser(
    description='BSF Runner for running the Tuxedo Cufflinks application.')
...
run_cufflinks = pickler_dict['cufflinks_executable']
assert isinstance(run_cufflinks, Executable)

child_return_code = Runnable.run(executable=run_cufflinks)

if child_return_code:
    raise Exception('Could not complete the Cufflinks step.')
