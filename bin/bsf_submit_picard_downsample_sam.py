...
#
"""The :py:mod:`bin.bsf_submit_picard_downsample_sam` module is a script to drive the
:py:class:`bsf.analyses.picard.DownsampleSam` analysis.
"""
...
argument_parser = ArgumentParser(
    description=DownsampleSam.name + ' driver script.')
